            ...
            >
                ...
                >
                    ...
                    <select
                        ...
                        onChange={(e) => handleFilterChanges("propertyType",e.target.value)}
                ...
                >
                    <label 
                        className='capitalize block text-sm font-medium text-gray-700 my-1'
                    htmlFor="status">status type</label>
                ...
                >
                    <label 
                        className='capitalize block text-sm font-medium text-gray-700 my-1'
                    htmlFor="bedrooms">bedrooms type</label>
                ...
                >
                    <label 
                        className='capitalize block text-sm font-medium text-gray-700 my-1'
                    htmlFor="bathrooms">bathrooms type</label>
                ...
                >
                    <label 
                        className='capitalize block text-sm font-medium text-gray-700 my-1'
                    htmlFor="minPrice">min price type</label>
                ...
                >
                    <label 
                        className='capitalize block text-sm font-medium text-gray-700 my-1'
                    htmlFor="maxPrice">max price type</label>
